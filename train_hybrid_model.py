...
def main():
    ...
    import json
    with open(PROJECT_ROOT / "base_metrics.json", "w") as f:
        json.dump(metrics, f)
        
    print("Model training complete. Files saved: scaler_X.pkl, scaler_y.pkl, lstm_base_model.h5, xgboost_hybrid.json, base_metrics.json")
